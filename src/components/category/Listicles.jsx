                        ...
                        <td className='py-2 px-2'>
                          <div className="flex items-center space-x-3">
                            <div className="inline-flex w-10 h-10">
                              <img alt="Benzinga image" width="100" height="100" className="w-10 h-10 object-cover rounded-full" src='https://pricing.ascendagency.com/_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F8n90kyzz%2Fproduction%2F077a0789cd1ba808a28c5891822715e9602e0dc4-1043x1043.webp%3Fw%3D100%26h%3D100&w=128&q=75' style={{ color: "transparent" }} /></div>
                            <div>
                              <div className="flex items-center"><a href="#" className="underline flex items-center group" target="_blank">Benzinga</a></div>
                              <div className="text-gray-500 text-sm font-semibold tracking-wide"><span className="text-xs font-medium mr-1 px-2.5 py-0.5 rounded" style={{ backgroundColor: "rgb(0, 0, 0) ", color: "rgb(255, 145, 227)" }}>Contributor</span></div></div></div>
                        </td>
